...
(function () {
  ...
  function render() {
    ...
    $('#home').innerHTML = `
      <div data-reveal><div class="text-sm subtle">${new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</div><h2 style="font-size:24px;margin-top:2px">${UI.greeting()}, ${esc(me.first)} 👋</h2></div>
      ${hero}
