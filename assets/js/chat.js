...
(function (global) {
  ...
  function mount(root, opts) {
    ...
    function renderCompose(c) {
      ...
      if (!opts.mobile && window.innerWidth > 900) setTimeout(() => ta.focus(), 50);
      function send() {
